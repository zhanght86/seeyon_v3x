...
/**
 * This is an object that contains data related to the mt_content_template table.
...
public abstract class BaseMtContentTemplate extends BaseModel  implements Serializable {

	public static String REF = "MtContentTemplate";
	 ...
	 */
	public BaseMtContentTemplate (java.lang.Long id) {
		this.setId(id);
		initialize();
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.seeyon.v3x.meeting.domain.MtContentTemplate)) return false;
		else {
			com.seeyon.v3x.meeting.domain.MtContentTemplate mtContentTemplate = (com.seeyon.v3x.meeting.domain.MtContentTemplate) obj;
			if (null == this.getId() || null == mtContentTemplate.getId()) return false;
			else return (this.getId().equals(mtContentTemplate.getId()));
		}
	}
