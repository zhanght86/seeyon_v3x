...
/**
 * This is an object that contains data related to the bul_log table.
...
public abstract class BaseBulLog extends BaseModel  implements Serializable {

	public static String REF = "BulLog";
	 ...
	 */
	public BaseBulLog (java.lang.Long id) {
		this.setId(id);
		initialize();
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.seeyon.v3x.bulletin.domain.BulLog)) return false;
		else {
			com.seeyon.v3x.bulletin.domain.BulLog bulLog = (com.seeyon.v3x.bulletin.domain.BulLog) obj;
			if (null == this.getId() || null == bulLog.getId()) return false;
			else return (this.getId().equals(bulLog.getId()));
		}
	}
