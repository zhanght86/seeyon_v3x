...
/**
 * This is an object that contains data related to the bul_data table.
...
public abstract class BaseBulData extends BaseModel  implements Serializable {

	public static String REF = "BulData";
	 ...
	 */
	public BaseBulData (java.lang.Long id) {
		this.setId(id);
		initialize();
	}
	...
	private java.util.Set<com.seeyon.v3x.bulletin.domain.BulPublishScope> bulScopes;
	
	private java.util.Set<com.seeyon.v3x.bulletin.domain.BulRead> bulReads;
	...
	/**
	 * Return the value associated with the column: bulReads
	 */
//	public void addTobulReads (com.seeyon.v3x.bulletin.domain.BulRead bulRead) {
//		if (null == getBulReads()) setBulReads(new java.util.TreeSet<com.seeyon.v3x.bulletin.domain.BulRead>());
//		getBulReads().add(bulRead);
//	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.seeyon.v3x.bulletin.domain.BulData)) return false;
		else {
			com.seeyon.v3x.bulletin.domain.BulData bulData = (com.seeyon.v3x.bulletin.domain.BulData) obj;
			if (null == this.getId() || null == bulData.getId()) return false;
			else return (this.getId().equals(bulData.getId()));
		}
	}
	...
	public java.util.Set<com.seeyon.v3x.bulletin.domain.BulPublishScope> getBulScopes() {
		return bulScopes;
	}

	public void setBulScopes(
			java.util.Set<com.seeyon.v3x.bulletin.domain.BulPublishScope> bulScopes) {
		this.bulScopes = bulScopes;
	}

	public java.util.Set<com.seeyon.v3x.bulletin.domain.BulRead> getBulReads() {
		return bulReads;
	}

	public void setBulReads(
			java.util.Set<com.seeyon.v3x.bulletin.domain.BulRead> bulReads) {
		this.bulReads = bulReads;
	}
