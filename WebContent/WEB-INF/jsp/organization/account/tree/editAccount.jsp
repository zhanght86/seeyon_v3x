...
<form id="editAccountForm" name="editAccountForm" method="post" action="${organizationURL}?method=updateAccountOfTree" onsubmit="return (submitOrgForm(createAccontValidate()&&tirmElementById('name')&&checkShortName()&& verifyPwdStrength() &&judgeFun()&&checkEMail(),this))">
