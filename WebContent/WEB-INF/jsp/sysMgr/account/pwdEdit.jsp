...
<script type="text/javascript"><!--
	...
	function submitForm() {
		...
		if (!(validateNameAccount() && validateOldPassword() && checkForm(postForm) && validate() && verifyPwdStrength())) {
			return;
		}
		
		$('#postForm').ajaxSubmit({
		      url : "<html:link renderURL='/accountManager.do' />?method=modifyManager&pwdAlert=1",
		      type : 'POST',
		      async : false,
	...
	<form id="postForm" method="post">
		...
		<table border="0" cellpadding="0" cellspacing="0" width="100%" height="100%" class="border_lr" align="center">
			<tr >
				...
				<fieldset height="100%"><legend >单位管理员密码修改</legend>
				<table width="80%" border="0" cellspacing="0" cellpadding="0"
					...
					<tr>
						...
						<td class="new-column" width="80%">
							<input disabled name="name" readonly="readonly" maxLength="40" maxSize="40" class="input-100per" type="text" id="name" value="<c:out value="${logerName }" escapeXml="true" />" inputName="<fmt:message key="manager.name.notnull" />" validate="notNull,isCriterionWord" />
						</td>
					</tr>
					<tr>
						<td class="bg-gray" width="20%" nowrap="nowrap"><label
