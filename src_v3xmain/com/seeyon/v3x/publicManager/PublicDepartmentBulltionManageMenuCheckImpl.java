 ...
 * 
 */
public class PublicDepartmentBulltionManageMenuCheckImpl implements MenuCheck {
	...
	public boolean check(long memberId, long loginAccountId) {
		/*boolean bul = false;
  		 bul = this.bulTypeManager.isDepartmentBulTypeManager(memberId,loginAccountId);	   		 
		return bul;*/
		return false;
	}
