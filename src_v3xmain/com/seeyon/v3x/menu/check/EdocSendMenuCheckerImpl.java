 ...
 *
 */
public class EdocSendMenuCheckerImpl implements MenuCheck
{
	private static final Log log = LogFactory.getLog(EdocSendMenuCheckerImpl.class);
    public boolean check(long memberId, long loginAccountId) {
        ...
        if(flag){
            try {
                return EdocRoleHelper.isEdocCreateRole(EdocEnum.edocType.sendEdoc.ordinal());
            }
