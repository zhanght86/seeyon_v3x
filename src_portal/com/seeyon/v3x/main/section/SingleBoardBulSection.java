 ...
 * 单板块单位公告栏目
 */
public class SingleBoardBulSection extends BaseSection {
	
	private static Log log = LogFactory.getLog(SingleBoardBulSection.class);
	...
	public BaseSectionTemplete projection(Map<String, String> preference) {
		...
		return BulletinSectionUtil.setBulSectionData(preference, null, bulDatas, BulTypeSpaceType.corporation.ordinal(), true, bulDataManager);
	}
