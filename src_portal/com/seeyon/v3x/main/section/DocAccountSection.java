...
public class DocAccountSection extends BaseSection {
    private static final Log log = LogFactory.getLog(DocAccountSection.class);
	...
	public String getName(Map<String, String> preference) {
		return SectionUtils.getSectionName("docAccount", preference);
	}
	...
	public BaseSectionTemplete projection(Map<String, String> preference) {
		...
		try {
			...
			list = docFavoriteManager.getFavoritesByCount(V3xOrgEntity.ORGENT_TYPE_ACCOUNT, accountId, count);
            ...
            log.error("单位空间知识文档异常：", e);
		}
		ct.addBottomButton(BaseSectionTemplete.BOTTOM_BUTTON_LABEL_MORE, "/doc.do?method=docFavoriteMore&userType=account");
		return ct;
	}
}