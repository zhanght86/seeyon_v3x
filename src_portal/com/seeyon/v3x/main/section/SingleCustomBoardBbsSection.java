...
public class SingleCustomBoardBbsSection extends BaseSection {
	private static Log log = LogFactory.getLog(SingleCustomBoardBbsSection.class);
	...
	@Override
	public String getId() {
		return "singleCustomBoardBbsSection";
	}
	...
	public BaseSectionTemplete projection(Map<String, String> preference) {
		...
		if(v3xBbsArticles != null){
			...
			for (V3xBbsArticle article : v3xBbsArticles) {
                ...
                row.setLink("/bbs.do?method=showPost&spaceId=" + spaceId + "&articleId="+article.getId()+"&resourceMethod=listLatestFiveArticleAndAllBoard", OPEN_TYPE.href_blank);
		...
		mt.addBottomButton("bbs_index_label", "/bbs.do?method=listLatestFiveArticleAndAllBoard&where=space&spaceType=" + spaceType + "&spaceId=" + spaceId);
