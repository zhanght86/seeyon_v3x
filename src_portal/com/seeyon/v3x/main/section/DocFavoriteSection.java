...
public class DocFavoriteSection extends BaseSection {
    private static final Log log = LogFactory.getLog(DocFavoriteSection.class);
	...
	public String getName(Map<String, String> preference) {
		return SectionUtils.getSectionName("docFavorite", preference);
	}
	...
	public BaseSectionTemplete projection(Map<String, String> preference) {
		...
		try {
			...
			List<DocFavorite> list = docFavoriteManager.findFavoritePersonalDocsByOrgByCount(userId, count);
            ...
            log.error("查询首页个人文档学习列表异常", e);
		}
		ct.addBottomButton(BaseSectionTemplete.BOTTOM_BUTTON_LABEL_MORE, "/doc.do?method=docFavoriteMore&userType=member");
		return ct;
	}
}