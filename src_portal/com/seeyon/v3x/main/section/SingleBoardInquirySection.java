 ...
 */
public class SingleBoardInquirySection extends BaseSection {
	private static Log log = LogFactory.getLog(SingleBoardInquirySection.class);
	...
	@Override
	public String getId() {
		return "singleBoardInquirySection";
	}
	...
	public BaseSectionTemplete projection(Map<String, String> preference) {
		...
		try {
			...
			for(SurveyBasicCompose sbc:ilist){
			 ...
			 mt.addBottomButton("inquiry_index_label", "/inquirybasic.do?method=recent_or_check&group=account&where=space");
			 mt.addBottomButton(BaseSectionTemplete.BOTTOM_BUTTON_LABEL_MORE, "/inquirybasic.do?method=more_recent_or_check&typeId="+boardId+"&group=account&from=section");
		}
		catch (Exception e) {
			log.error("", e);
		}
