...
public abstract class Constants {
	private static boolean stopSyn = false;
	
	//视频会议用户角色
	//可以创建视频会议的（默认的）
	public static final String USER_CREATE_CONF ="24000";
	//普通用户
	public static final String USER_ORID ="240001";
	//siteadmin登陆操作权限
	public static final String USER_SITE_ADMIN ="1";
	
	
	
	//视频会议同步用户名密码
	public static final String SYN_USER_NAME ="admin";
	//public static final String SYN_PASSWORD ="seeyon_admin";
	public static final String SYN_PASSWORD ="G2AC6wlCXuLtfpUMo2+EpUv09RY=";
	
	//视频会议用户名密码都用一样的
	public static final String ALL_USER_PASSWORD ="111111";
    public static final String SYN_URL = VideoConferenceConfig.WEBBASEURL+"/integration/xml";
    ...
    //没有当前人员异常
    public static final String NO_MEMBER_ERROR = "0x1031020";
    

    public static boolean getStopSyn() {
		return stopSyn;
	}
	public static void setStopSyn(boolean stopSyn) {
		Constants.stopSyn = stopSyn;
	}
